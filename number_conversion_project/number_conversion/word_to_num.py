...
#             return self.number + '0' + self.convert(string[4:])
#         elif string.startswith('one'):
#             return self.number + '1' + self.convert(string[3:])
#         elif string.startswith('two'):
#             return self.number + '2' + self.convert(string[3:])
#         elif string.startswith('three'):
#             return self.number + '3' + self.convert(string[5:])
#         elif string.startswith('four'):
#             return self.number + '4' + self.convert(string[4:])
#         elif string.startswith('five'):
#             return self.number + '5' + self.convert(string[4:])
#         elif string.startswith('six'):
#             return self.number + '6' + self.convert(string[3:])
#         elif string.startswith('seven'):
#             return self.number + '7' + self.convert(string[5:])
#         elif string.startswith('eight'):
#             return self.number + '8' + self.convert(string[5:])
#         elif string.startswith('nine'):
#             return self.number + '9' + self.convert(string[4:])
#         elif not string:
#             return ""
#         else:
